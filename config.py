...
class Config(object):
    ...
    # database config
    DATABASE_NAME = os.environ.get("DATABASE_NAME","mydata")     
    DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://ajmerasaini01:U1sGiZRI6Ha0xuCy@cluster0.tnok3d0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
    ")

    # other configs
    BOT_UPTIME = time.time()
    START_PIC = (os.environ.get("START_PIC", "https://envs.sh/N2f.jpg https://envs.sh/N2a.jpg https://envs.sh/N2O.jpg")).split()
    ADMIN = int(os.environ.get("ADMIN", "8413546109"))

    # channels
    IS_FSUB = os.environ.get("IS_FSUB", "False").lower() == "true"  # Set "True" For Enable Force Subscribe
    AUTH_CHANNELS = list(map(int, os.environ.get("AUTH_CHANNELS", "-1003161993313").split())) # Add Multiple Channels iD By Space
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003161993313"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1003161993313"))
